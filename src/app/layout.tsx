...
function WhatsAppBubble() {
  return (
    <a
      href="https://wa.me/96170000000?text=Hi%20SahhaDaily!%20I%27d%20like%20to%20browse%20your%20products%20%F0%9F%8C%BF"
      target="_blank"
    ...
    <footer className="footer" id="contact">
      <div className="container footerGrid">
        ...
        <div>
          ...
          <p style={{ marginBottom: 8 }}>
            <a href="mailto:hello@sahhadaily.lb" style={{ color: "var(--muted)" }}>
              hello@sahhadaily.lb
            </a>
          </p>
